...
@Configuration
@EnableJpaRepositories(basePackages = "com.regis.datasource.repository.clubefato", entityManagerFactoryRef = "clubeFatoEntityManagerFactory", transactionManagerRef = "clubeFatoTransactionManager")
...
public class ClubefatoConfig {
	...
	public LocalContainerEntityManagerFactoryBean clubeFatoEntityManagerFactory() {
		...
		factory.setPackagesToScan("com.regis.datasource.model.clubefato");
